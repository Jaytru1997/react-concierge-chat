                    ...
                    if (msg && msg.timestamp > lastAdminTimestamp.current) {
                        ...
                        if (msg.sender === 'client') {
                            if (soundEnabled || document.hidden) {
                                triggerNativeNotification(`Live Chat from ${msg.senderName || 'Client'}`, msg.text);
                            }
                        }
                    }
                }
                            ...
                            return (_jsxs("div", { onClick: () => setSelectedSessionId(s.sessionId), style: {
                                ...
                                gap: '12px',
                                    ...
                                    return (_jsx("div", { style: {
                                            ...
                                            }, children: [_jsx("div", { style: { fontSize: '10px', opacity: 0.7, marginBottom: '2px', textTransform: 'uppercase' }, children: isAgent ? m.senderName || adminName : m.senderName || 'Visitor' }), _jsx("div", { children: m.text }), _jsx("div", { style: { fontSize: '10px', opacity: 0.7, textAlign: 'right', marginTop: '4px' }, children: timeStr })] }) }, m.id));
                                ...
                                overflowX: 'auto',
                                    ...
                                    cursor: 'pointer',
                                    whiteSpace: 'nowrap',
                                }, children: r }, idx))) }), _jsxs("form", { onSubmit: (e) => handleSendReply(e), style: {
                                padding: '12px 16px',
                                borderTop: '1px solid rgba(255, 255, 255, 0.08)',
                                backgroundColor: '#0B132B',
                                display: 'flex',
                                gap: '8px',
                            }, children: [_jsx("input", { type: "text", placeholder: `Reply as ${adminName}...`, value: replyText, onChange: (e) => setReplyText(e.target.value), style: {
                                        flex: 1,
                                        padding: '10px 14px',
                                        borderRadius: '10px',
                                        border: '1px solid rgba(255, 255, 255, 0.1)',
                                        ...
                                        fontSize: '13px',
                                        outline: 'none',
                                    } }), _jsx("button", { type: "submit", disabled: !replyText.trim(), style: {
                                        backgroundColor: primaryColor,
                                        color: '#FFFFFF',
                                        border: 'none',
                                        borderRadius: '10px',
                                    ...
                                    }, children: "Send Reply" })] })] })) : (_jsx("div", { style: { flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#64748B' }, children: "Select a session from the list to start chatting" })) })] }));
};
